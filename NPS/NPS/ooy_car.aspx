<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ooy_car.aspx.vb" Inherits="NPS.ooy_car" %>
      ...
      <div class="content-wrapper">
        <section class="content-header">
          <h1 class="text-center">
            ปริมาณอ้อยเข้าหีบ และ จำนวนรถลานใน-ลานนอก
          </h1>
        </section>
        ...
        <section class="content">
          <div class="row">
            ...
            <div class="box">
                ...
                <table class="table table-bordered">
                    <tr>
                      <th class="text-center">ปริมาณอ้อยรวม (ตัน)</th>
                      <th class="text-center">รถลานนอก (คัน)</th>
                      <th class="text-center">จำนวนรถลานใน (คัน)</th>                   
                    </tr>    
                    <tr>
          ...
          <div class="row">
            ...
            <div class="box">
                ...
                <table class="table table-bordered">
                    <tr>
                      <th class="text-center">รวมราง A</th>
                      <th class="text-center">รวมราง B</th>
