<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="procedure.aspx.vb" Inherits="NPS.procedure" %>
          ...
          <div class="row">
            ...
            <div class="box">
                <div class="box-body table-responsive no-padding">
                  <table class="table table-bordered">
                    ...
                    <tr>
                      <td>แรงดันไอเสีย 1.5  (1 - 1.4)</td>
                      <td>XXXX.X</td> 
                      <td>kg/cm2</td>                   
                    </tr>
                    <tr>
                      <td>แรงดันไอเสีย 1.0  (0.8 - 1.2)</td>
                      <td>XXXX.X</td> 
                      <td>kg/cm2</td>                   
                    </tr>
                    <tr>
                      <td>น้ำเชื่อมดิบหลังหม้อปั่น</td>
                      <td>XXXX.X</td> 
                      <td>%</td>                   
                    </tr>
                    <tr>
            ...
            <div class="box">
                <div class="box-body table-responsive no-padding">
                  <table class="table table-bordered">
                    <tr>
                        <th colspan=4 class="text-center">หม้อต้ม</th>
                    </tr>
                    <tr>
                      <td>Flow Mix Juice</td>
                      <td>XXX.X</td>
                      <td>XXX.X</td>
                      <td>m3/hr</td>                    
                    </tr>
                    <tr>
                      <td>Flow น้ำอ้อยแถว A</td>
                    ...
                    <tr>
                      <td>Flow น้ำอ้อยแถว B</td>
                      <td colspan=2 class="text-center">XXX.X</td> 
                      <td>m3/hr</td>                   
                    </tr>
                    <tr>
                      <td>Flow น้ำอ้อยแถว C</td>
                      <td colspan=2 class="text-center">XXX.X</td> 
                      <td>m3/hr</td>                   
                    </tr>
                    <tr>
            ...
            <div class="col-md-4">
              <div class="box">
                <div class="box-body table-responsive no-padding">
                  <table class="table table-bordered">
                    <tr>
                        <th>ปริมาณอ้อยรวม (ตัน/วัน)</th>
                        <th>รถลานนอก (คัน)</th>
                        <th>จำนวนรถลานใน (คัน)</th>
                    </tr>
                    <tr>
              ...
              <div class="box">
                <div class="box-body table-responsive no-padding">
                  <table class="table table-bordered">
                    <tr>
                        <th colspan=3 class="text-center">รีไฟน์</th>
                    </tr>
                    <tr>
                      <td>ระดับ น้ำ Condenser (ท่าน้ำ)</td>
                      <td>XXX.X</td>
                      <td>%</td>                    
                    </tr>
                    <tr>
                      <td>ระดับ น้ำเชื่อมละลาย ถังรีไฟน์</td>
                      <td>XXX.X</td>
                      <td>%</td>                    
                    </tr>
                    <tr>
                      <td>อัตราการไหล น้ำเชื่อม เข้าหม้อฟอก 1</td>
                      <td>XXX.X</td>
                      <td>m3/hr</td>                    
                    </tr>
                    <tr>
            ...
            <div class="box">
                <div class="box-body table-responsive no-padding">
                  <table class="table table-bordered">
                    <tr>
                      <th colspan=3 class="text-center">หม้อเคี่ยว</th>                    
                    </tr>
                    <tr>
                      <td>Flow น้ำเชื่อมเข้าหม้อ A1</td>
                      <td>XX.X</td> 
                      <td>m3/hr</td>                   
                    </tr>
                    <tr>
                      <td>Flow น้ำเชื่อมเข้าหม้อ A2</td>
                      <td>XX.X</td> 
                      <td>m3/hr</td>                   
                    </tr>
                    <tr>
                      <td>Flow น้ำเชื่อมเข้าหม้อ A3</td>
                      <td>XX.X</td> 
                      <td>m3/hr</td>                   
                    </tr>
                    <tr>
                      <td>Flow น้ำเชื่อมเข้าหม้อ A4</td>
                      <td>XX.X</td> 
                      <td>m3/hr</td>                   
                    </tr>
                    <tr>
                      <td>Flow น้ำเชื่อมเข้าหม้อ A8</td>
                      <td>XX.X</td> 
                      <td>m3/hr</td>                   
                    </tr>
                    <tr>
                      <td>Flow น้ำเหลืองเอ เข้าหม้อ B5</td>
                      <td>XX.X</td> 
                      <td>m3/hr</td>                   
                    </tr>
                    <tr>
                      <td>Flow น้ำเหลืองเอ เข้าหม้อ B6</td>
                      <td>XX.X</td> 
                      <td>m3/hr</td>                   
                    </tr>
                    <tr>
                      <td>Flow น้ำเหลืองบี เข้าหม้อ C7</td>
                      <td>XX.X</td> 
                      <td>m3/hr</td>                   
                    </tr>
                    <tr>
                      <td>Flow น้ำเหลืองบี เข้าหม้อ FCB 90</td>
                      <td>XX.X</td> 
                      <td>m3/hr</td>                   
                    </tr>
                    <tr>
                      <td>Flow น้ำเหลืองบี เข้าหม้อ FCB 120</td>
                      <td>XX.X</td> 
                      <td>m3/hr</td>                   
                    </tr>                  
                  </table>
