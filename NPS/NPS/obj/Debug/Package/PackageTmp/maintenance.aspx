<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="maintenance.aspx.vb" Inherits="NPS.maintenance" %>
          ...
          <div class="row">
            ...
            <div class="box">
                ...
                <table class="table table-bordered">
                    <tr>
                      <th>ระดับน้ำ Condenser</th>
                      <td>XX.X</td>
                      <td>%</td>                   
                    </tr>    
                    <tr>
                      <th>อุณหภูมิ ใต้ห้องรีไฟน์</th>
                      <td>XX.X</td>
                      <td>C</td>                   
                    </tr>   
                    <tr>
                      <th>รอบเทอร์ไบน์ Ebara ตัวที่ 1</th>
                      <td>XX.X</td>
                      <td>RPM</td>                   
                    </tr>  
                    <tr>
                      <th>รอบเทอร์ไบน์ Ebara ตัวที่ 2</th>
                      <td>XX.X</td>
                      <td>RPM</td>                   
                    </tr>
                    <tr>
                      <th>รอบเทอร์ไบน์ Ebara ตัวที่ 3</th>
                      <td>XX.X</td>
                      <td>RPM</td>                   
                    </tr>
                    <tr>
                      <th>รอบเทอร์ไบน์ Ebara ตัวที่ 4</th>
                      <td>XX.X</td>
                      <td>RPM</td>                   
                    </tr>
                    <tr>
                      <th>รอบเทอร์ไบน์ Ebara ตัวที่ 5</th>
                      <td>XX.X</td>
                      <td>RPM</td>                   
                    </tr>
                    <tr>
                      <th>รอบเทอร์ไบน์ Ebara ตัวที่ 6</th>
                      <td>XX.X</td>
                      <td>RPM</td>                   
                    </tr>  
                    <tr>
                      <th>ระดับน้ำบ่อพักแม่น้ำปิง</th>
                      <td>XX.X</td>
                      <td>%</td>                   
                    </tr>     
                    <tr>
                      <th>อัตราการไหลน้ำจากแม่น้ำปิง</th>
                      <td>XX.X</td>
                      <td>m3/h</td>                   
                    </tr>   
                  </table>
