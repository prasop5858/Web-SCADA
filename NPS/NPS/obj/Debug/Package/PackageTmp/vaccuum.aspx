<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="vaccuum.aspx.vb" Inherits="NPS.vaccuum" %>
            ...
            <div class="box">
                <div class="box-body table-responsive no-padding">
                  <table class="table table-bordered">
                    ...
                    <tr>
                      <td>ระดับน้ำเชื่อมคอนเซนต์หม้อเคี่ยวโรงเก่า</td>
                      <td>XX.X</td>
                      <td>%</td>                   
                    </tr>  
                    <tr>
                      <td>แว๊คคั่มหม้อต้ม คอนเซนต์เตเตอร์</td>
                      <td>XX.X</td>
                      <td>%</td>                   
                    </tr>                  
                  </table>
