                    ...
                    <tr>
                      ...
                      <td class="text-center">
                          <cc1:OPCWebControlsLabel ID="OPCWebControlsLabel1" runat="server" 
                              ...
                              TextOPCSystems_Tag="DirectOPC:Kepware.KEPServerEX.V5\เตา 40-80 ตัน.เครื่องบันทึก 3.ch 6:DirectOPCUpdateRate:1:DirectOPCDataType:Object Type:DirectOPCAccessPath:" 
                              UpdateAll="False">
                          </cc1:OPCWebControlsLabel>
                        </td> 
                      <td colspan=3 class="text-center">XXX.X</td> 
                      <td class="text-center">&nbsp;</td>
                      <td class="text-center">
                          <cc1:OPCWebControlsLabel ID="OPCWebControlsLabel2" runat="server" 
                              AutogenScripts="False" DynamicValidation="False" ErrorBehavior="Eat" 
                              TextOPCSystems_Tag="\\192.168.0.21\DirectOPC:Kepware.KEPServerEX.V5\เตา 200 เอ.เครื่องบันทึก 2.ch 2:DirectOPCUpdateRate:1:DirectOPCDataType:Object Type:DirectOPCAccessPath:" 
