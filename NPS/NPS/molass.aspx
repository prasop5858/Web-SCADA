<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="molass.aspx.vb" Inherits="NPS.molass" %>
          ...
          <div class="row">
            ...
            <div class="box">
                        <div class="text-center">
                            <b style="font-size: 16px">อุณหภูมิ ถังโมลาส (C)</b>
                        </div>
            </div>
            </div>
          </div>
            ...
            <div class="box">
                <div class="box-body table-responsive no-padding">
                  <table class="table table-bordered">
                    ...
                    <tr>
                      <td class="text-center">Brix น้ำเหลืองก่อนขาย</td>
                      <td>XX.X</td>
                      <td>82 - 83</td>
                    </tr>             
                  </table>
